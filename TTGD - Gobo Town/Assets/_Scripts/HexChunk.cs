...
public class HexChunk : MonoBehaviour
{
    ...
    public void Chunk(GameObject hexChunkModel_Prefab, Material[,] mergedBiomeMats_Arr)
    {
        ...
        for (int i = 0; i < chunkedHexModels_List.Count; i++)
        {
            ...
            chunkedHexModels_List[i].transform.GetComponent<MeshRenderer>().material = HexSpawnController.GetChunkMaterial(currentMatIDs_List[i].Item1, currentMatIDs_List[i].Item2);
        }
